export ORACLE_INSTANTCLIENT_MAJOR=11.2
export ORACLE_INSTANTCLIENT_VERSION=11.2.0.4.0
export ORACLE=/usr/local/oracle
export ORACLE_HOME=$ORACLE/lib/oracle/$ORACLE_INSTANTCLIENT_MAJOR/client64
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$ORACLE_HOME/lib
export C_INCLUDE_PATH=$C_INCLUDE_PATH:$ORACLE/include/oracle/$ORACLE_INSTANTCLIENT_MAJOR/client64
